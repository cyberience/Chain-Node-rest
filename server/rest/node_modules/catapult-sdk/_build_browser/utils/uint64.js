...
var uint64Module = {
  ...
  */
	fromUint: function fromUint(number) {
		...
		if (0x00200000 <= value[1] || 0 > number || 0 !== number % 1) throw Error('number cannot be converted to uint \'' + number + '\'');
  ...
  */
	fromHex: function fromHex(input) {
		...
		var uint8Array = convert.hexToUint8(input);
  ...
  */
	toHex: function toHex(uint64) {
		...
		var uint8Array = convert.uint32ToUint8(uint32Array).reverse();
