...
var BinarySerializer = require('../serializer/BinarySerializer');
var SerializedSizeCalculator = require('../serializer/SerializedSizeCalculator');
var convert = require('../utils/convert');

var serializeToBuffer = function serializeToBuffer(codec, entity) {
  var calculator = new SerializedSizeCalculator();
  codec.serialize(entity, calculator);

  var serializer = new BinarySerializer(calculator.size());
...
var serialize = {
   ...
   */
  toHex: function toHex(codec, entity) {
    return convert.uint8ToHex(serializeToBuffer(codec, entity));
  },
