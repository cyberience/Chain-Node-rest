...
var toStringInternal = function toStringInternal(code) {
	switch (code) {
		case 0x00000000:
			return 'Success';
		case 0x40000000:
		...
		case 0x8043000A:
			return 'Failure_Core_Timestamp_Too_Far_In_Future';
		case 0x8043000F:
		...
		case 0x80411001:
			return 'Failure_Aggregate_Ineligible_Cosigners';
		case 0x80411002:
			return 'Failure_Aggregate_Missing_Cosigners';
		case 0x804C0001:
			return 'Failure_Lock_Invalid_Hash_Algorithm';
		case 0x804C0002:
			return 'Failure_Lock_Invalid_Mosaic_Id';
		case 0x804C0003:
			return 'Failure_Lock_Invalid_Mosaic_Amount';
		case 0x804C0004:
			return 'Failure_Lock_Hash_Exists';
		case 0x804C0005:
			return 'Failure_Lock_Hash_Does_Not_Exist';
		case 0x804C0006:
			return 'Failure_Lock_Missing_Secret_Padding';
		case 0x804C0007:
			return 'Failure_Lock_Hash_Not_Implemented';
		case 0x804C0008:
			return 'Failure_Lock_Proof_Size_Out_Of_Bounds';
		case 0x804C0009:
			return 'Failure_Lock_Secret_Mismatch';
		case 0x804C000A:
		...
		case 0x804C000E:
			return 'Failure_Lock_Hash_Already_Used';
		case 0x804C000F:
			return 'Failure_Lock_Secret_Already_Used';
		case 0x804C0010:
			return 'Failure_Lock_Invalid_Duration';
		case 0x80550001:
		...
		case 0x8055000A:
			return 'Failure_Multisig_Modify_Max_Cosigned_Accounts';
		case 0x8055000B:
			return 'Failure_Multisig_Modify_Max_Cosigners';
		case 0x8055000C:
			return 'Failure_Multisig_Modify_Loop';
		case 0x8055000D:
			return 'Failure_Multisig_Modify_Max_Multisig_Depth';
		case 0x80550800:
			return 'Failure_Multisig_Operation_Not_Permitted_By_Account';
		case 0x804E0001:
		...
		case 0x804E0064:
			return 'Failure_Namespace_Invalid_Namespace_Type';
		case 0x804E0065:
		...
		case 0x81FE1002:
			return 'Failure_Consumer_Hash_In_Recency_Cache';
		case 0x80FE2001:
			return 'Failure_Consumer_Remote_Chain_Too_Many_Blocks';
		case 0x80FE2002:
		...
		case 0x80FE3002:
			return 'Failure_Consumer_Remote_Chain_Mismatched_Difficulties';
		case 0x80FE3003:
...
var status = {
  ...
  */
	toString: function toString(code) {
		var str = toStringInternal(code);
		if (undefined !== str) return str;

		var hexString = code.toString(16).toUpperCase();
		if (8 > hexString.length) hexString = '0'.repeat(8 - hexString.length) + hexString;
