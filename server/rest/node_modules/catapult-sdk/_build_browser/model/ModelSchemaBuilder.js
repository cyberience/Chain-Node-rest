...
var ModelSchemaBuilder = function () {
	/**
  * Creates a model schema builder.
  */
	function ModelSchemaBuilder() {
		_classCallCheck(this, ModelSchemaBuilder);
  ...
  */
	...
	_createClass(ModelSchemaBuilder, [{
		key: 'setAllowedTransactions',
		value: function setAllowedTransactions(allowedTransactions) {
			// prepare reverse mapping id => string
			this.entityTypeToString = Object.keys(allowedTransactions).reduce(function (state, name) {
   ...
   */
		...
		key: 'typeToName',
		value: function typeToName(transactionType) {
			if (!(transactionType in this.entityTypeToString)) throw Error('transactionType is not in the list of allowed transactions \'' + transactionType + '\'');
   ...
   */
		...
		value: function addTransactionSupport(transactionType, schema) {
			var name = this.typeToName(transactionType);
   ...
   */
		...
		value: function addSchema(name, schema) {
			if (this.schema[name]) throw Error('schema already registered for \'' + name + '\'');
   ...
   */
		...
		key: 'transactionSchemaNameSupplier',
		value: function transactionSchemaNameSupplier() {
			var _this = this;

			// default to transaction
			return function (transaction) {
				var transactionName = _this.entityTypeToString[transaction.type];
				return transactionName && _this.schema[transactionName] ? transactionName : 'transaction';
			};
		}
   ...
   */
	...
	return ModelSchemaBuilder;
}();

module.exports = ModelSchemaBuilder;
//# sourceMappingURL=ModelSchemaBuilder.js.map