...
var PacketType = require('../packet/PacketType');
...
var isPacketHeaderValid = function isPacketHeaderValid(packet, packetTypeName) {
	var headerInfo = headerInfos[packetTypeName];
...
var challengeParser = {
  ...
  */
	tryParseServerChallengeRequest: function tryParseServerChallengeRequest(packet) {
		if (!isPacketHeaderValid(packet, 'server')) return undefined;
  ...
  * @returns {object} The parsed packet or undefined.
  */
	tryParseClientChallengeResponse: function tryParseClientChallengeResponse(packet) {
		if (!isPacketHeaderValid(packet, 'client')) return undefined;
